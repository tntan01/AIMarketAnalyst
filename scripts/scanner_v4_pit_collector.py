...
Run:
    python scripts/scanner_v4_pit_collector.py --schema
    python scripts/scanner_v4_pit_collector.py --dataset DATA.jsonl \\
        --out reports/scanner-v4/pit_evidence.json \\
