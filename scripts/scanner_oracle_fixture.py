...
Run:  python scripts/scanner_oracle_fixture.py

Writes ``reports/scanner/oracle_fixture.json`` — a frozen, versioned V4
...
OUTPUT = PROJECT_ROOT / "reports" / "scanner" / "oracle_fixture.json"
...
def _build_report() -> dict[str, object]:
    ...
    return {
        "schema": "scanner-oracle-fixture",
        "generated_by": "scripts/scanner_oracle_fixture.py",
