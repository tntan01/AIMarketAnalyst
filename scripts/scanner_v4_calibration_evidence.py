...
Run:  python scripts/scanner_v4_calibration_evidence.py
...
from core.scanner_v4_safety_audit import audit_safety_data
...
def _build_report() -> dict[str, object]:
    ...
    return {
        "report_version": "scanner-v4-b09-evidence-v1",
...
def main() -> None:
    ...
    out_path = "reports/scanner_v4_b09_evidence.json"
