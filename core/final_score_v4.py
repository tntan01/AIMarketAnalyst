"""Pure, target-only Scanner V4 FinalScore fallback and rounding contract.

Step 06 of the Scanner V4 migration builds the *score* contract for FinalScore:
...
This module is intentionally NOT wired into the executable scanner.  The V3
...
from core.scanner_v4_models import SCANNER_V4_SCORING_VERSION, VALID_SIDES

FINAL_SCORE_POLICY_VERSION = "scanner-final-score-v4"
...
class FinalScoreResult:
    """Immutable, auditable output of the locked V4 FinalScore blend.
...
def score_final_score(
    ...
    *,
    ...
    """Blend the three per-side scores with the locked V4 formula.
    ...
    contract and custom/adaptive weights cannot influence V4.
    """
