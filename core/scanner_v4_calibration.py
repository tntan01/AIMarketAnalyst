"""Scanner V4 backtest calibration reproducibility (Bước 09; target-only).
...
from core.reason_codes import (
    SCANNER_V4_CALIBRATION_INSUFFICIENT,
)

SCANNER_V4_CALIBRATION_MANIFEST_VERSION = "scanner-v4-calibration-manifest-v1"
SCANNER_V4_CALIBRATION_REPORT_VERSION = "scanner-v4-calibration-report-v1"
...
def run_calibration(
    ...
    if len(rows) >= manifest.minimum_required_rows and realized:
        ...
        reason_codes = (SCANNER_V4_CALIBRATION_INSUFFICIENT,)
    ...
    return CalibrationReport(
        report_version=SCANNER_V4_CALIBRATION_REPORT_VERSION,
