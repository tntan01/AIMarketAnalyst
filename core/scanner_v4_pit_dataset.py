...
* mọi snapshot phải có UTC aware timestamp + provenance + canonical V4
...
PIT_DATASET_VERSION = "scanner-v4-pit-dataset-v1"
UTC = timezone.utc
...
# ``compose_scanner_v4`` and never touches the live decision path.  A human /
