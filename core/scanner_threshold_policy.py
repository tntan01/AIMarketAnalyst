"""Scanner threshold policy (Bước 08; target-only, not live-wired yet).
...
SCANNER_THRESHOLD_POLICY_VERSION = "scanner-threshold-policy"
SCANNER_THRESHOLD_POLICY_LEGACY_VERSION = "scanner-threshold-policy-v4"
...
def _require_policy_version(value: object) -> str:
    if type(value) is not str or value not in (
        ...
        raise ThresholdPolicyError(
            ...
            f"{SCANNER_THRESHOLD_POLICY_VERSION!r}",
        )
    return value
