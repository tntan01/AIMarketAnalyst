"""Scanner V4 Bước 11 shared fixture helpers (target-only; NOT a pytest file).

This module is imported only by the Bước 11 verification-test files.  It builds
deterministic immutable ``ScannerV4Snapshot`` objects (and the underlying SMC /
...
from core.final_score_v4 import FINAL_SCORE_NEUTRAL_FALLBACK_SOURCE
...
def build_snapshot(
    *,
    ...
    """Build a deterministic immutable V4 snapshot (live or backtest adapter).
...
def compose(
    ...
    *,
    ...
    from core.scanner_v4_composition import compose_scanner_v4
