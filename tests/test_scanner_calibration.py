"""Scanner calibration reproducibility (Bước 09, target-only).
...
from core.reason_codes import SCANNER_CALIBRATION_INSUFFICIENT
from core.scanner_calibration import (
    SCANNER_CALIBRATION_MANIFEST_VERSION,
    SCANNER_CALIBRATION_REPORT_VERSION,
    CalibrationInput,
    CalibrationManifest,
    CalibrationReport,
...
class TestInsufficientSample:
    def test_empty_rows_reports_insufficient(self):
        ...
        assert SCANNER_CALIBRATION_INSUFFICIENT in report.reason_codes
...
class TestReproducibility:
    ...
    def test_report_version_locked(self):
        report = run_calibration(_manifest(), ())
        assert report.report_version == SCANNER_CALIBRATION_REPORT_VERSION
