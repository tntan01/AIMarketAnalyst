"""Scanner V4 — PIT dataset collector/validator (Bước 09; target-only).

Exercises the fail-closed contract of ``core/scanner_v4_pit_dataset.py``:
...
from core.scanner_v4_pit_dataset import (
    PIT_DATASET_VERSION,
    CategoryObservation,
...
class TestCalibrationMapping:
    def test_insufficient_sample_renders_no_thresholds_fail_closed(self) -> None:
        ...
        assert SCANNER_V4_CALIBRATION_INSUFFICIENT in evidence.calibration.reason_codes
