"""Scanner V4 — Mục 13 scenario matrix (Bước 11; target-only).
...
def snapshot_captured_in_future():
    ...
    from tests.scanner_v4_testkit import NOW
...
# V4's single fail-safe neutral-50 fallback (``fallback_neutral_50``), because the
