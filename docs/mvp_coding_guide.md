...
- Ngay truoc khi dat lenh phai lay live ask/bid, check gia con trong `entry_zone` va tinh `current_effective_rr`; gia ngoai zone hoac current RR < `min_rr` thi skip.
