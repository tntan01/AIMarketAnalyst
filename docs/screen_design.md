...
- Cột trái (20%, font 11px, padding 6/4, spacing 1px):
  ...
  - Card "🎯 Số liệu giao dịch" — hiển thị Execution zone, Source zone, độ
    rộng execution, lý do trim/reject, SL, TP, R:R kèm dải worst–best và base
    effective, Vĩ mô và Chế độ TT
