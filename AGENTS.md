# AGENTS.md — AI Market Analyst

## Vision Rule

**When the user attaches, uploads, or references an image file** (screenshot, photo, diagram, chart, etc.), follow the skill at `.Codex/skills/vision_for_deepseek.md`.
...
- API details and script template are in `.Codex/skills/vision_for_deepseek.md`
